...
public class DeleteNote extends HttpServlet {
   ...
   final static String URL = "jdbc:mysql://123.60.33.200/Note";
   final static String USER = "root";
   final static String PASS = "2001314syqSYQ!";
   final static String SQL_DELETE_NOTE = "DELETE FROM t_notepad WHERE id=?";
